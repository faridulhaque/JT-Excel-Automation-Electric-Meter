    ...
    >
      <div className="flex justify-between items-start">
        <div className="mt-3">
          ...
          <p className="text-sm dark:text-gray-300 text-gray-700 mt-2">Meter No: {m.meterNo}</p>
        </div>
      </div>

      <div className="mt-6 space-y-2 text-sm dark:text-gray-300 text-gray-700">
        <p>
          <span className="dark:text-gray-400 text-gray-600">Threshold:</span> {m.threshold}
        </p>
      </div>
